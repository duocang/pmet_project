...
class PMETExecutor:
    ...
    # workspace-level entries under scripts/pipeline/.
    SCRIPT_MAP = {
        "promoters_pre": "scripts/pipeline/promoters_only_pair.sh",
        "promoters": "scripts/pipeline/promoters_index_pair.sh",
        "intervals": "scripts/pipeline/intervals_index_pair.sh",
    }

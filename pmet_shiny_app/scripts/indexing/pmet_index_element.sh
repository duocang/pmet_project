...
# -------------------------------------------------------------------------------------------
# 7. IC per motif. calculateICfrommeme expects one motif per file, so split
#    MEME into per-motif files, compute IC, then discard them (FIMO uses a
#    different, batched split below).

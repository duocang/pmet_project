...
/*
  These extern prototypes conflict with the static inline definitions below
  when MT_EXTERN is defined as 'static' (GCC on any platform).
  Only declare them when inline code will NOT be generated in the header.
*/
...
#else /* __cplusplus */
/* Use static for both Linux and Apple to avoid multiple definition errors */
#define MT_EXTERN	static
#endif /* __cplusplus */
#endif /* MT_EXTERN */

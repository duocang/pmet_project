...
// /**
//  * Write FimoFile contents to a specified file path.
//  * @param fimoFile The FimoFile to write.
//  * @param outputPath The file path where to write the contents.
//  * @return Boolean indicating success of the write operation.
//  */
// bool writeFimoFile(FimoFile *fimoFile, const char *outputPath);

// /**
//  * Print FimoFile metadata and summary to console.
//  * @param fimoFile The FimoFile to print.
//  */

...
clean_builds() {
    ...
    rm -rf "$PROJECT_ROOT/src/indexing/from_c/build"
    rm -rf "$PROJECT_ROOT/src/indexing/from_cpp/build"
    rm -rf "$PROJECT_ROOT/src/indexing/fused_fimo/build"
    rm -rf "$PROJECT_ROOT/src/pairing/original/build"
    rm -rf "$PROJECT_ROOT/src/pairing/parallel/build"
    print_success "Build directories cleaned"
}

clean_results() {
    print_step "Cleaning result directories..."
    rm -rf "$PROJECT_ROOT/results/demo"
    rm -rf "$PROJECT_ROOT/src/indexing/from_c/result"
    rm -rf "$PROJECT_ROOT/src/indexing/from_cpp/result"
    rm -rf "$PROJECT_ROOT/src/indexing/fused_fimo/result"
    rm -rf "$PROJECT_ROOT/src/pairing/original/result"
    rm -rf "$PROJECT_ROOT/src/pairing/parallel/result"

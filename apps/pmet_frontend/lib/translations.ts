...
const en = {
  ...
  'admin.dashboard.section.stats.placeholder': 'Stats will appear here in the next update — submit volume, status mix, runtime distribution, top error reasons.',
...
const zh: Record<keyof typeof en, string> = {
  ...
  'admin.dashboard.section.stats.placeholder': '统计图表将在下次更新加入 —— 提交量、状态分布、运行时长分布、Top 错误原因。',

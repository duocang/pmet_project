...
const en = {
  ...
  'data.summary': 'Currently installed: {species} species · {entries} (species, motif database) pairs.',
  'data.loading': 'Loading installed indexes…',
  'data.err.failed': 'Could not list installed indexes.',
...
const zh: Record<keyof typeof en, string> = {
  ...
  'data.summary': '本机已安装：{species} 个物种 · {entries} 对 (species, motif 数据库)。',
  'data.loading': '加载已安装索引中…',
  'data.err.failed': '加载已安装索引列表失败。',

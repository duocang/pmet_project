...
const en = {
  ...
  'submit.upload.cli_promoter_label': 'Promoter mode (genome + annotation):',
  'submit.upload.cli_intervals_label': 'Intervals / peaks mode:',
...
const zh: Record<keyof typeof en, string> = {
  ...
  'submit.upload.cli_promoter_label': 'Promoter 模式（基因组 + 注释）：',
  'submit.upload.cli_intervals_label': 'Intervals / Peak 模式：',
